...
from generation_utils.dream_generation_utils_original import DreamGenerationMixin, DreamGenerationConfig
...
class DreamModel(DreamGenerationMixin, DreamPreTrainedModel):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        global total_time_ms, count
        # print(f"Average time over {count} runs: {total_time_ms/count:.4f} ms")
