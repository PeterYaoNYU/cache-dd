...
class Dream(LM):
    def __init__(
        ...
        cache_type: Optional[str] = "decoded",
        cache_steps: Optional[int] = 4,
        shift_type: Optional[str] = "right",
        **kwargs,
    ) -> None:
        super().__init__()
        ...
        print(f"eval_dream.py: Using cache: {self.use_cache}, cache type: {self.cache_type}, cache steps: {self.cache_steps}")
